...
export const CONTENT_HUB: ContentItem[] = [
  ...
  {
    id: "relatorio-case-vps-oracle-always-free",
    type: "relatorio",
    title: "Case: o que a Oracle promete vs. o que realmente acontece no Always Free",
    description:
      "Bugs reais, um subagente que errou e um limite de requisições mal-entendido — o relato de tentar rodar um servidor grátis para sempre.",
    durationMinutes: 7,
    xpReward: 30,
    recommendedStage: "automacoes",
    bodyPath: "content/relatorios/case-vps-oracle-always-free.md",
    embedUrl: null,
    publishedAt: "2026-09-08",
    capacityFit: ["equilibrio", "essencial"],
  },
  {
    id: "relatorio-tutorial-vps-oracle",
    type: "relatorio",
    title: "Tutorial: como criar sua VPS Always Free na Oracle sem cair nos mesmos buracos",
    description:
      "Passo a passo prático com os 4 obstáculos reais, a causa raiz de cada um e a correção — para não repetir o mesmo tempo perdido.",
    durationMinutes: 6,
    xpReward: 30,
    recommendedStage: "fundacao_local",
    bodyPath: "content/relatorios/tutorial-vps-oracle-sem-buracos.md",
    embedUrl: null,
    publishedAt: "2026-09-08",
    capacityFit: ["equilibrio", "essencial"],
  },
  {
    id: "podcast-case-vps-oracle-always-free",
    type: "podcast",
    title: "O Custo Real do Always Free Oracle",
    description:
      "Áudio gerado a partir do case real: o que a VPS grátis da Oracle entrega de verdade, sem esconder os erros no caminho.",
    durationMinutes: 24,
    xpReward: 20,
    recommendedStage: "automacoes",
